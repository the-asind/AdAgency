...
INSERT INTO "Billboards" ("BillboardId", "Address", "CityDistrict", "LocationDescription", "RegistrationNumber",
                          "RentAmountPerWeek", "UsefulArea")
VALUES (1, 'Address 1', 'District 1', 'Location 1', 'RN1', 100.0, 100.0);
INSERT INTO "Billboards" ("BillboardId", "Address", "CityDistrict", "LocationDescription", "RegistrationNumber",
                          "RentAmountPerWeek", "UsefulArea")
VALUES (2, 'Address 2', 'District 2', 'Location 2', 'RN2', 200.0, 200.0);

INSERT INTO "Renters" ("RenterId", "BankAccountNumber", "BankName", "ContactPersonName", "ContactPersonPhone",
                       "DirectorName", "DirectorPhone", "Email", "Inn", "LegalAddress", "Name", "Status")
VALUES (1, 'Account1', 'Bank1', 'Contact1', 'Phone1', 'Director1', 'Phone1', 'email@1.com', 'Inn1', 'Address1',
        'Renter1', 'Status1');
INSERT INTO "Renters" ("RenterId", "BankAccountNumber", "BankName", "ContactPersonName", "ContactPersonPhone",
                       "DirectorName", "DirectorPhone", "Email", "Inn", "LegalAddress", "Name", "Status")
VALUES (2, 'Account2', 'Bank2', 'Contact2', 'Phone2', 'Director2', 'Phone2', NULL, 'Inn2', 'Address2', 'Renter2',
        'Status2');

INSERT INTO "Contracts" ("ContractId", "AdditionalTerms", "AgencyResponsible", "ContractNumber", "PaymentType",
                         "RenterId", "SigningDate", "Status", "TotalAmount")
...
INSERT INTO "ContractBillboards" ("Id", "AdvertisementPhotoLink", "BillboardId", "ContractId", "RentAmount",
                                  "RentEndDate", "RentStartDate")
VALUES (1,
        'https://mods.store.gx.me/mod/32027713-3e24-46ea-98d2-708f13991e17/cover/5b8f3267-3ad1-444e-8f75-83bab0a48848/webp-640x360?4b8390341bc39300397de58b9cb17301',
        1, 1, 1000.0, TIMESTAMPTZ '2024-11-19T21:39:37.265803Z', TIMESTAMPTZ '2024-10-29T21:39:37.265803Z');
INSERT INTO "ContractBillboards" ("Id", "AdvertisementPhotoLink", "BillboardId", "ContractId", "RentAmount",
                                  "RentEndDate", "RentStartDate")
VALUES (2, 'https://avatars.mds.yandex.net/get-mpic/4880383/img_id745194673364714228.jpeg/orig', 2, 2, 2000.0,
        TIMESTAMPTZ '2024-11-12T21:39:37.265804Z', TIMESTAMPTZ '2024-10-29T21:39:37.265804Z');
