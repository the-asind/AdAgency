...
namespace AdAgency.Migrations
{
    ...
    [Migration("20241125205850_add_timestamp_to_audit")]
    partial class add_timestamp_to_audit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AdAgency.Models.Billboard", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            LocationDescription = "У входа в п��рк",
            ...
            modelBuilder.Entity("AdAgency.Models.Contract", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RenterId = 1,
                            SigningDate = new DateTime(2024, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Status = "Активен",
            ...
            modelBuilder.Entity("AdAgency.Models.ContractBillboard", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContractId = 1,
                            RentAmount = 30000.0m,
                            RentEndDate = new DateTime(2025, 1, 26, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RentStartDate = new DateTime(2024, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                        ...
                        new
                        {
                            ...
                            ContractId = 2,
                            RentAmount = 25000.0m,
                            RentEndDate = new DateTime(2025, 2, 26, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RentStartDate = new DateTime(2024, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            ContractId = 3,
                            RentAmount = 28000.0m,
                            RentEndDate = new DateTime(2025, 3, 26, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RentStartDate = new DateTime(2024, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            ContractId = 4,
                            RentAmount = 35000.0m,
                            RentEndDate = new DateTime(2025, 4, 26, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RentStartDate = new DateTime(2024, 11, 26, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
