...
namespace AdAgency.Migrations
{
    ...
    [Migration("20241029213127_Initial")]
            ...
            modelBuilder.Entity("AdAgency.Models.Contract", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PaymentType = "Cash",
                            RenterId = 1,
                            SigningDate = new DateTime(2024, 10, 30, 4, 31, 27, 467, DateTimeKind.Local).AddTicks(3484),
                            Status = "active",
                            TotalAmount = 0m
                        },
                        new
            ...
            modelBuilder.Entity("AdAgency.Models.ContractBillboard", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContractId = 1,
                            RentAmount = 1000m,
                            RentEndDate = new DateTime(2024, 10, 30, 4, 31, 27, 467, DateTimeKind.Local).AddTicks(3524),
                            RentStartDate = new DateTime(2024, 10, 30, 4, 31, 27, 467, DateTimeKind.Local).AddTicks(3521)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            ContractId = 2,
                            RentAmount = 2000m,
                            RentEndDate = new DateTime(2024, 10, 30, 4, 31, 27, 467, DateTimeKind.Local).AddTicks(3527),
                            RentStartDate = new DateTime(2024, 10, 30, 4, 31, 27, 467, DateTimeKind.Local).AddTicks(3526)
                        });
                });
