...
namespace AdAgency.Migrations
{
    ...
    [Migration("20241029212649_Initial")]
            ...
            modelBuilder.Entity("AdAgency.Models.Contract", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PaymentType = "Cash",
                            RenterId = 1,
                            SigningDate = new DateTime(2024, 10, 30, 4, 26, 48, 941, DateTimeKind.Local).AddTicks(4614),
                            Status = "active",
                            TotalAmount = 0m
                        },
                        new
            ...
            modelBuilder.Entity("AdAgency.Models.ContractBillboard", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContractId = 1,
                            RentAmount = 1000m,
                            RentEndDate = new DateTime(2024, 10, 30, 4, 26, 48, 941, DateTimeKind.Local).AddTicks(4645),
                            RentStartDate = new DateTime(2024, 10, 30, 4, 26, 48, 941, DateTimeKind.Local).AddTicks(4643)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            ContractId = 2,
                            RentAmount = 2000m,
                            RentEndDate = new DateTime(2024, 10, 30, 4, 26, 48, 941, DateTimeKind.Local).AddTicks(4647),
                            RentStartDate = new DateTime(2024, 10, 30, 4, 26, 48, 941, DateTimeKind.Local).AddTicks(4647)
                        });
                });
