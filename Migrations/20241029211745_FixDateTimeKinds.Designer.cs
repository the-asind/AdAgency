...
namespace AdAgency.Migrations
{
    ...
    [Migration("20241029211745_FixDateTimeKinds")]
    partial class FixDateTimeKinds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AdAgency.Models.Contract", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PaymentType = "Cash",
                            RenterId = 1,
                            SigningDate = new DateTime(2024, 10, 30, 4, 17, 45, 390, DateTimeKind.Local).AddTicks(9208),
                            Status = "active",
                            TotalAmount = 0m
                        },
                        new
            ...
            modelBuilder.Entity("AdAgency.Models.ContractBillboard", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContractId = 1,
                            RentAmount = 1000m,
                            RentEndDate = new DateTime(2024, 10, 30, 4, 17, 45, 390, DateTimeKind.Local).AddTicks(9239),
                            RentStartDate = new DateTime(2024, 10, 30, 4, 17, 45, 390, DateTimeKind.Local).AddTicks(9236)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            ContractId = 2,
                            RentAmount = 2000m,
                            RentEndDate = new DateTime(2024, 10, 30, 4, 17, 45, 390, DateTimeKind.Local).AddTicks(9241),
                            RentStartDate = new DateTime(2024, 10, 30, 4, 17, 45, 390, DateTimeKind.Local).AddTicks(9240)
                        });
                });
