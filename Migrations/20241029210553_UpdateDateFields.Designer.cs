...
namespace AdAgency.Migrations
{
    ...
    [Migration("20241029210553_UpdateDateFields")]
            ...
            modelBuilder.Entity("AdAgency.Models.Contract", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PaymentType = "Cash",
                            RenterId = 1,
                            SigningDate = new DateTime(2024, 10, 30, 4, 5, 53, 329, DateTimeKind.Local).AddTicks(5745),
                            Status = "active",
                            TotalAmount = 0m
                        },
                        new
            ...
            modelBuilder.Entity("AdAgency.Models.ContractBillboard", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ContractId = 1,
                            RentAmount = 1000m,
                            RentEndDate = new DateTime(2024, 10, 30, 4, 5, 53, 329, DateTimeKind.Local).AddTicks(5778),
                            RentStartDate = new DateTime(2024, 10, 30, 4, 5, 53, 329, DateTimeKind.Local).AddTicks(5777)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            ContractId = 2,
                            RentAmount = 2000m,
                            RentEndDate = new DateTime(2024, 10, 30, 4, 5, 53, 329, DateTimeKind.Local).AddTicks(5781),
                            RentStartDate = new DateTime(2024, 10, 30, 4, 5, 53, 329, DateTimeKind.Local).AddTicks(5780)
                        });
                });
